...
The [contract implementation](../../contracts/gnark_verifier/src/lib.rs) is **auto-generated** from `verification_key.json` using [soroban-verifier-gen](https://github.com/mysteryon88/soroban-verifier-gen) (Groth16 verifier generator for Soroban). The [test suite](../../contracts/gnark_verifier/src/test.rs) demonstrates off-chain parsing of the proof and verification key, along with successful contract execution.
...
Step-by-step gnark circuit setup and generation of keys/proof for the `gnark_verifier` contract. Run the commands in order.
